...
public class GameGrid : MonoBehaviour
{
    ...
    private bool IsMustHaveGroundHeight(GridCell cell)
    {
        switch (gridType)
        {
            ...
            case GridType.Circle:
                return centreCells.Contains(cell) || grid[cell.Pos.x].First().Pos.y == cell.Pos.y || grid[cell.Pos.x].Last().Pos.y == cell.Pos.y || grid.First()[cell.Pos.y].Pos.x == cell.Pos.x || grid.Last()[cell.Pos.y].Pos.x == cell.Pos.x;
            default:
                return false;
